...
//    }
    ...
    {
//        echo "__construct ".$trans."<br/>";
        $this->trans = $trans;
        $this->pdo = TestDbPool::getDB($trans);
    }

    public function __destruct()
    {
//        echo "__destruct ". $this->trans."<br/>";
        TestDbPool::closeDB($this->trans);
    ...
    */
    ...
    public function count(){
        ...
        $this->execute($query, $params);
        return $this->sQuery->fetch($fetchmode)['count'];
